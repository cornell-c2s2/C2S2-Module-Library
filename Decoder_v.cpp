...
#include "obj_dir_Decoder/VDecoder.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_Decoder/VDecoder__Syms.h"
#include "svdpi.h"
#endif
...
VDecoder_t * create_model( const char *vcd_filename ) {
  ...
  m     = (VDecoder_t *) malloc( sizeof(VDecoder_t) );
  model = new VDecoder();
...
void destroy_model( VDecoder_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VDecoder * model = (VDecoder *) m->model;
...
#if VLINETRACE
void trace( VDecoder_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_Decoder__v );
